...
const css$9 = {
  code: "@import url('https://fonts.googleapis.com/css2?family=Cute+Font&display=swap');@font-face{font-family:FastSS;src:url('$lib/assets/fonts/PLANK.ttf') format('truetype')}@font-face{font-family:Font3D;src:url('$lib/assets/fonts/Fontout.ttf') format('truetype')}.wrapper.svelte-1xy50jt.svelte-1xy50jt{background-color:#365ab4;background:linear-gradient(to top, #abc3ef, #365ab4);box-shadow:inset 0px 0px 150px rgba(0, 0, 0, 0.65);font-family:'Cute Font', cursive;color:#000;margin:0;padding:0;position:relative;min-height:100vh;overflow:hidden;display:flex;overflow:hidden}.container.svelte-1xy50jt.svelte-1xy50jt{width:100%;margin:0 auto;padding:0px;z-index:1;display:flex;flex-direction:column;align-items:center;justify-content:center}.title.svelte-1xy50jt.svelte-1xy50jt{width:293px;text-align:center;position:absolute;top:54%;left:50%;transform:translate(-50%, -50%);text-align:center;z-index:1}.header.svelte-1xy50jt img.svelte-1xy50jt{display:block;width:400px}h1.svelte-1xy50jt.svelte-1xy50jt{font-family:FastSS;font-size:3em;color:#fff;z-index:3;background-image:url($lib/assets/MaxthonImages/stainless-steel-texture-388.png);background-repeat:repeat;-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent}h4.svelte-1xy50jt.svelte-1xy50jt{font-family:Font3D;font-size:3em;color:#fff;z-index:3;background-image:url($lib/assets/MaxthonImages/stainless-steel-texture-388.png);background-repeat:repeat;-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;text-align:center;animation-name:svelte-1xy50jt-spin, svelte-1xy50jt-depth;animation-timing-function:linear;animation-iteration-count:infinite;animation-duration:3s;transform-style:preserve-3d;position:relative;display:inline-block}h4.svelte-1xy50jt.svelte-1xy50jt::before,h4.svelte-1xy50jt.svelte-1xy50jt::after{content:'';display:block;position:absolute;width:100%;height:100%;top:0;transform:rotateY(0.5deg);transform-origin:0 50%;-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent}h4.svelte-1xy50jt.svelte-1xy50jt::after{transform:rotateY(-0.5deg);transform-origin:100% 50%}@keyframes svelte-1xy50jt-spin{from{transform:rotateY(0deg)}to{transform:rotateY(-360deg)}}@keyframes svelte-1xy50jt-depth{0%{text-shadow:0 0 5px #878686,\n				0 0 10px #545454,\n				0 0 15px #f5f5f5}25%{text-shadow:1px 0 5px #878686,\n				2px 0 10px #545454,\n				3px 0 15px #f5f5f5,\n				4px 0 20px #272626}50%{text-shadow:0 0 5px #878686,\n				0 0 10px #545454,\n				0 0 15px #f5f5f5}75%{text-shadow:-1px 0 5px #878686,\n				-2px 0 10px #545454,\n				-3px 0 15px #f5f5f5,\n				-4px 0 20px #272626}100%{text-shadow:0 0 5px #878686,\n				0 0 10px #545454,\n				0 0 15px #f5f5f5}}.header.svelte-1xy50jt.svelte-1xy50jt{color:#fff;display:inline-block;position:relative}.footer.svelte-1xy50jt.svelte-1xy50jt{background-color:transparent;color:#fff;text-align:center;padding:20px;width:100%}.menu.svelte-1xy50jt.svelte-1xy50jt{display:flex;justify-content:space-around;padding:10px;margin-bottom:20px}.glassbuble.svelte-1xy50jt.svelte-1xy50jt{position:absolute;top:5%;left:15%;transform:translate(-50%, -50%);z-index:10}.glasscyclone.svelte-1xy50jt.svelte-1xy50jt{position:absolute;bottom:-23%;right:-23%;z-index:10}.sidebar.svelte-1xy50jt.svelte-1xy50jt{width:150px;background-color:#c3cbdc;background-image:linear-gradient(147deg, #c3cbdc 0%, #edf1f4 74%);border-radius:5px;padding:10px;float:left;margin-right:20px}.content.svelte-1xy50jt.svelte-1xy50jt{width:calc(100% - 240px);float:left}.project-item.svelte-1xy50jt.svelte-1xy50jt{background-color:#c3cbdc;background-image:linear-gradient(147deg, #c3cbdc 0%, #edf1f4 74%);border-radius:5px;margin-bottom:20px;padding:10px}.project-item.svelte-1xy50jt h2.svelte-1xy50jt{font-size:1.8em}.project-item.svelte-1xy50jt p.svelte-1xy50jt{font-size:1.2em}.categories.svelte-1xy50jt.svelte-1xy50jt{list-style-type:none}.clearfix.svelte-1xy50jt.svelte-1xy50jt::after{content:'';clear:both;display:table}.grid-wrapper.svelte-1xy50jt.svelte-1xy50jt{position:absolute;width:100%;height:100%;left:0;bottom:0px;perspective:200px;z-index:0;overflow:hidden}.blog-container.svelte-1xy50jt.svelte-1xy50jt{background-image:url($lib/assets/MaxthonImages/MELT_FRAME.png);background-repeat:no-repeat;background-size:contain;margin:-60px auto 0;width:100%;max-width:800px;height:600px;padding:0px 100px 0px 100px;position:relative;z-index:2;overflow:hidden;display:flex;justify-content:center;align-items:center}.blog.svelte-1xy50jt.svelte-1xy50jt{width:600px;height:330px;overflow-y:auto;padding:0px;box-sizing:border-box;display:flex;flex-direction:column;padding-bottom:20px}.glass-overlay.svelte-1xy50jt.svelte-1xy50jt{position:absolute;top:17%;left:17%;width:630px;height:350px;background:rgba(255, 255, 255, 0.2);backdrop-filter:blur(5px);border-radius:45px;box-shadow:0 4px 6px rgba(0, 0, 0, 0.1);pointer-events:none;padding:7px 12px 8px 12px;z-index:1;text-align:center}.loader.svelte-1xy50jt.svelte-1xy50jt{size:10rem;margin-top:70px}.blink.svelte-1xy50jt.svelte-1xy50jt{animation:svelte-1xy50jt-blink-animation 1s steps(5, start) infinite;-webkit-animation:svelte-1xy50jt-blink-animation 1s steps(5, start) infinite}@keyframes svelte-1xy50jt-blink-animation{to{visibility:hidden}}.grid.svelte-1xy50jt.svelte-1xy50jt{position:absolute;top:0;left:0;right:0;bottom:0;width:100%;height:100%;margin-top:-50px;transform:rotateX(45deg)}.floating.svelte-1xy50jt.svelte-1xy50jt{animation-name:svelte-1xy50jt-floating;animation-duration:3s;animation-iteration-count:infinite;animation-timing-function:ease-in-out;margin-left:30px;margin-top:5px}@keyframes svelte-1xy50jt-floating{0%{transform:translate(0, 0px)}50%{transform:translate(0, 15px)}100%{transform:translate(0, -0px)}}.line.svelte-1xy50jt.svelte-1xy50jt{position:absolute;background:rgba(155, 158, 217, 0.35);backface-visibility:hidden}.vertical.svelte-1xy50jt .line.svelte-1xy50jt{top:0;left:0;bottom:0;width:5px;background:linear-gradient(\n			to bottom,\n			rgba(255, 255, 255, 0),\n			rgba(155, 158, 217, 0.35)\n		)}.vertical.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(1){left:10%}.vertical.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(2){left:20%}.vertical.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(3){left:30%}.vertical.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(4){left:40%}.vertical.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(5){left:50%}.vertical.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(6){left:60%}.vertical.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(7){left:70%}.vertical.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(8){left:80%}.vertical.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(9){left:90%}.vertical.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(10){left:100%;margin-left:-1px}.horizontal.svelte-1xy50jt .line.svelte-1xy50jt{top:0;left:0;right:0;height:5px;z-index:2}.horizontal.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(1){top:10%;opacity:0.2}.horizontal.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(2){top:20%;opacity:0.3}.horizontal.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(3){top:30%;opacity:0.4}.horizontal.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(4){top:40%;opacity:0.5}.horizontal.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(5){top:50%;opacity:0.6}.horizontal.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(6){top:60%;opacity:0.7}.horizontal.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(7){top:70%;opacity:0.8}.horizontal.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(8){top:80%;opacity:0.9}.horizontal.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(9){top:90%;opacity:0.95}.horizontal.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(10){top:100%;margin-top:-1px;opacity:1}.horizontal.svelte-1xy50jt .line.svelte-1xy50jt:nth-child(11){opacity:0.05}.dot.svelte-1xy50jt.svelte-1xy50jt{position:absolute;background:#57c1e8;width:5px;height:5px;top:100%;border-radius:5px;box-shadow:0 0 3px #fff;backface-visibility:hidden}.dot.svelte-1xy50jt.svelte-1xy50jt:nth-child(1){left:10%;animation:svelte-1xy50jt-moveDot 5s infinite}.dot.svelte-1xy50jt.svelte-1xy50jt:nth-child(2){left:20%;animation:svelte-1xy50jt-moveDot 20s infinite}.dot.svelte-1xy50jt.svelte-1xy50jt:nth-child(3){left:30%;animation:svelte-1xy50jt-moveDot 15s infinite}.dot.svelte-1xy50jt.svelte-1xy50jt:nth-child(4){left:50%;animation:svelte-1xy50jt-moveDot 30s infinite}.dot.svelte-1xy50jt.svelte-1xy50jt:nth-child(5){left:60%;animation:svelte-1xy50jt-moveDot 12s infinite}.dot.svelte-1xy50jt.svelte-1xy50jt:nth-child(6){left:80%;animation:svelte-1xy50jt-moveDot 6s infinite}.dot.svelte-1xy50jt.svelte-1xy50jt:nth-child(7){left:90%;animation:svelte-1xy50jt-moveDot 8s infinite}@keyframes svelte-1xy50jt-moveDot{0%{top:100%;opacity:1}100%{top:0%;opacity:0}}",
  map: `{"version":3,"file":"Projects.svelte","sources":["Projects.svelte"],"sourcesContent":["<script>\\n\\timport Y2Kaesthetic from '$lib/assets/MaxthonImages/6.png';\\n\\timport Bubble from './components/Bubble.svelte';\\n\\timport glassBuble from '$lib/assets/MaxthonImages/1.png';\\n\\timport glassCyclone from '$lib/assets/MaxthonImages/2.png';\\n\\timport starLink from '$lib/assets/MaxthonImages/star.gif';\\n\\n\\tconst bubbles = Array.from({ length: 20 });\\n<\/script>\\n\\n<div class=\\"wrapper\\">\\n\\t<div class=\\"grid-wrapper\\">\\n\\t\\t<div class=\\"grid\\">\\n\\t\\t\\t<div class=\\"vertical\\">\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t</div>\\n\\t\\t\\t<div class=\\"dots\\">\\n\\t\\t\\t\\t<div class=\\"dot\\"></div>\\n\\t\\t\\t\\t<div class=\\"dot\\"></div>\\n\\t\\t\\t\\t<div class=\\"dot\\"></div>\\n\\t\\t\\t\\t<div class=\\"dot\\"></div>\\n\\t\\t\\t\\t<div class=\\"dot\\"></div>\\n\\t\\t\\t\\t<div class=\\"dot\\"></div>\\n\\t\\t\\t\\t<div class=\\"dot\\"></div>\\n\\t\\t\\t</div>\\n\\t\\t\\t<div class=\\"horizontal\\">\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t\\t<div class=\\"line\\"></div>\\n\\t\\t\\t</div>\\n\\t\\t</div>\\n\\t</div>\\n\\t<div class=\\"glassbuble\\"><img src={glassBuble} alt=\\"bubbles\\" /></div>\\n\\n\\t<div class=\\"container\\">\\n\\t\\t{#each bubbles as _, i}\\n\\t\\t\\t<Bubble\\n\\t\\t\\t\\tsize={\`\${Math.random() * 50 + 20}px\`}\\n\\t\\t\\t\\tcolor={\`rgba(155, 158, 217, \${Math.random() * 0.5 + 0.3})\`}\\n\\t\\t\\t/>\\n\\t\\t{/each}\\n\\t\\t<div class=\\"header floating\\">\\n\\t\\t\\t<div class=\\"title\\"><h1>Projects</h1></div>\\n\\t\\t\\t<div><img src={Y2Kaesthetic} alt=\\"y2k aesthetic\\" /></div>\\n\\t\\t</div>\\n\\t\\t<div class=\\"blog-container\\">\\n\\t\\t\\t<div class=\\"glass-overlay\\">\\n\\t\\t\\t\\t<div class=\\"loader\\">\\n\\t\\t\\t\\t\\t<span>𓆩.⚝.𓆪</span>\\n\\t\\t\\t\\t\\t<div><h4>loading</h4></div>\\n\\t\\t\\t\\t\\t<span class=\\"blink\\">✧</span>\\n\\t\\t\\t\\t\\t<span class=\\"blink\\">✧</span>\\n\\t\\t\\t\\t\\t<span class=\\"blink\\">✧</span>\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t</div>\\n\\t\\t\\t<div class=\\"blog\\">\\n\\t\\t\\t\\t<div class=\\"menu\\">\\n\\t\\t\\t\\t\\t<a href=\\"/\\"><img src={starLink} alt=\\"star link\\" /></a>\\n\\t\\t\\t\\t\\t<a href=\\"/about\\"><img src={starLink} alt=\\"star link\\" /></a>\\n\\t\\t\\t\\t\\t<a href=\\"/contact\\"><img src={starLink} alt=\\"star link\\" /></a>\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t<div class=\\"clearfix\\">\\n\\t\\t\\t\\t\\t<div class=\\"sidebar\\">\\n\\t\\t\\t\\t\\t\\t<h2>Categories</h2>\\n\\t\\t\\t\\t\\t\\t<ul class=\\"categories\\">\\n\\t\\t\\t\\t\\t\\t\\t<li>Web Design</li>\\n\\t\\t\\t\\t\\t\\t\\t<li>Graphic Design</li>\\n\\t\\t\\t\\t\\t\\t\\t<li>Development</li>\\n\\t\\t\\t\\t\\t\\t</ul>\\n\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t<div class=\\"content\\">\\n\\t\\t\\t\\t\\t\\t<div class=\\"project-item\\">\\n\\t\\t\\t\\t\\t\\t\\t<h2>Travel Site</h2>\\n\\t\\t\\t\\t\\t\\t\\t<p>Java and MySQL on the back end. Angular front-end.</p>\\n\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t<div class=\\"project-item\\">\\n\\t\\t\\t\\t\\t\\t\\t<h2>Booking Platform</h2>\\n\\t\\t\\t\\t\\t\\t\\t<p>Django and SQLlite backend. The front end is Svelte.</p>\\n\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t<div class=\\"project-item\\">\\n\\t\\t\\t\\t\\t\\t\\t<h2>Hexwood Hunt (Game)</h2>\\n\\t\\t\\t\\t\\t\\t\\t<p>No framerworks, just JavaScript, HTML and CSS.</p>\\n\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t<div class=\\"project-item\\">\\n\\t\\t\\t\\t\\t\\t\\t<h2>Windows XP Portfolio</h2>\\n\\t\\t\\t\\t\\t\\t\\t<p>Sveltekit, other small projects called in for a more realistic experience.</p>\\n\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t</div>\\n\\t\\t</div>\\n\\t\\t<div class=\\"footer\\">&copy; 2024 Full Stack 🥞 . All rights reserved.</div>\\n\\t</div>\\n\\t<div class=\\"glasscyclone\\"><img src={glassCyclone} alt=\\"cyclone\\" /></div>\\n</div>\\n\\n<style>\\n\\t@import url('https://fonts.googleapis.com/css2?family=Cute+Font&display=swap');\\n\\n\\t@font-face {\\n\\t\\tfont-family: FastSS;\\n\\t\\tsrc: url('$lib/assets/fonts/PLANK.ttf') format('truetype');\\n\\t}\\n\\n\\t@font-face {\\n\\t\\tfont-family: Font3D;\\n\\t\\tsrc: url('$lib/assets/fonts/Fontout.ttf') format('truetype');\\n\\t}\\n\\n\\t.wrapper {\\n\\t\\tbackground-color: #365ab4;\\n\\t\\tbackground: linear-gradient(to top, #abc3ef, #365ab4);\\n\\t\\tbox-shadow: inset 0px 0px 150px rgba(0, 0, 0, 0.65);\\n\\t\\tfont-family: 'Cute Font', cursive;\\n\\t\\tcolor: #000;\\n\\t\\tmargin: 0;\\n\\t\\tpadding: 0;\\n\\t\\tposition: relative;\\n\\t\\tmin-height: 100vh;\\n\\t\\toverflow: hidden;\\n\\t\\tdisplay: flex;\\n\\t\\toverflow: hidden;\\n\\t}\\n\\n\\t.container {\\n\\t\\twidth: 100%;\\n\\t\\tmargin: 0 auto;\\n\\t\\tpadding: 0px;\\n\\t\\tz-index: 1;\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\talign-items: center;\\n\\t\\tjustify-content: center;\\n\\t}\\n\\n\\t.title {\\n\\t\\twidth: 293px;\\n\\t\\ttext-align: center;\\n\\t\\tposition: absolute;\\n\\t\\ttop: 54%;\\n\\t\\tleft: 50%;\\n\\t\\ttransform: translate(-50%, -50%);\\n\\t\\ttext-align: center;\\n\\t\\tz-index: 1;\\n\\t}\\n\\t.header img {\\n\\t\\tdisplay: block;\\n\\t\\twidth: 400px;\\n\\t}\\n\\th1 {\\n\\t\\tfont-family: FastSS;\\n\\t\\tfont-size: 3em;\\n\\t\\tcolor: #fff;\\n\\t\\tz-index: 3;\\n\\t\\tbackground-image: url($lib/assets/MaxthonImages/stainless-steel-texture-388.png);\\n\\t\\tbackground-repeat: repeat;\\n\\t\\t-webkit-background-clip: text;\\n\\t\\tbackground-clip: text;\\n\\t\\t-webkit-text-fill-color: transparent;\\n\\t}\\n\\n\\th4 {\\n\\t\\tfont-family: Font3D;\\n\\t\\tfont-size: 3em;\\n\\t\\tcolor: #fff;\\n\\t\\tz-index: 3;\\n\\t\\tbackground-image: url($lib/assets/MaxthonImages/stainless-steel-texture-388.png);\\n\\t\\tbackground-repeat: repeat;\\n\\t\\t-webkit-background-clip: text;\\n\\t\\tbackground-clip: text;\\n\\t\\t-webkit-text-fill-color: transparent;\\n\\t\\ttext-align: center;\\n\\t\\tanimation-name: spin, depth;\\n\\t\\tanimation-timing-function: linear;\\n\\t\\tanimation-iteration-count: infinite;\\n\\t\\tanimation-duration: 3s;\\n\\t\\ttransform-style: preserve-3d;\\n\\t\\tposition: relative;\\n\\t\\tdisplay: inline-block;\\n\\t}\\n\\n\\th4::before,\\n\\th4::after {\\n\\t\\tcontent: '';\\n\\t\\tdisplay: block;\\n\\t\\tposition: absolute;\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t\\ttop: 0;\\n\\t\\ttransform: rotateY(0.5deg);\\n\\t\\ttransform-origin: 0 50%;\\n\\t\\t-webkit-background-clip: text;\\n\\t\\tbackground-clip: text;\\n\\t\\t-webkit-text-fill-color: transparent;\\n\\t}\\n\\n\\th4::after {\\n\\t\\ttransform: rotateY(-0.5deg);\\n\\t\\ttransform-origin: 100% 50%;\\n\\t}\\n\\n\\t@keyframes spin {\\n\\t\\tfrom {\\n\\t\\t\\ttransform: rotateY(0deg);\\n\\t\\t}\\n\\t\\tto {\\n\\t\\t\\ttransform: rotateY(-360deg);\\n\\t\\t}\\n\\t}\\n\\n\\t@keyframes depth {\\n\\t\\t0% {\\n\\t\\t\\ttext-shadow:\\n\\t\\t\\t\\t0 0 5px #878686,\\n\\t\\t\\t\\t0 0 10px #545454,\\n\\t\\t\\t\\t0 0 15px #f5f5f5;\\n\\t\\t}\\n\\t\\t25% {\\n\\t\\t\\ttext-shadow:\\n\\t\\t\\t\\t1px 0 5px #878686,\\n\\t\\t\\t\\t2px 0 10px #545454,\\n\\t\\t\\t\\t3px 0 15px #f5f5f5,\\n\\t\\t\\t\\t4px 0 20px #272626;\\n\\t\\t}\\n\\t\\t50% {\\n\\t\\t\\ttext-shadow:\\n\\t\\t\\t\\t0 0 5px #878686,\\n\\t\\t\\t\\t0 0 10px #545454,\\n\\t\\t\\t\\t0 0 15px #f5f5f5;\\n\\t\\t}\\n\\t\\t75% {\\n\\t\\t\\ttext-shadow:\\n\\t\\t\\t\\t-1px 0 5px #878686,\\n\\t\\t\\t\\t-2px 0 10px #545454,\\n\\t\\t\\t\\t-3px 0 15px #f5f5f5,\\n\\t\\t\\t\\t-4px 0 20px #272626;\\n\\t\\t}\\n\\t\\t100% {\\n\\t\\t\\ttext-shadow:\\n\\t\\t\\t\\t0 0 5px #878686,\\n\\t\\t\\t\\t0 0 10px #545454,\\n\\t\\t\\t\\t0 0 15px #f5f5f5;\\n\\t\\t}\\n\\t}\\n\\n\\t.header {\\n\\t\\tcolor: #fff;\\n\\t\\tdisplay: inline-block;\\n\\t\\tposition: relative;\\n\\t}\\n\\n\\t.footer {\\n\\t\\tbackground-color: transparent;\\n\\t\\tcolor: #fff;\\n\\t\\ttext-align: center;\\n\\t\\tpadding: 20px;\\n\\t\\twidth: 100%;\\n\\t}\\n\\n\\t.menu {\\n\\t\\tdisplay: flex;\\n\\t\\tjustify-content: space-around;\\n\\t\\tpadding: 10px;\\n\\t\\tmargin-bottom: 20px;\\n\\t}\\n\\n\\t.glassbuble {\\n\\t\\tposition: absolute;\\n\\t\\ttop: 5%;\\n\\t\\tleft: 15%;\\n\\t\\ttransform: translate(-50%, -50%);\\n\\t\\tz-index: 10;\\n\\t}\\n\\n\\t.glasscyclone {\\n\\t\\tposition: absolute;\\n\\t\\tbottom: -23%;\\n\\t\\tright: -23%;\\n\\t\\tz-index: 10;\\n\\t}\\n\\n\\t.sidebar {\\n\\t\\twidth: 150px;\\n\\t\\tbackground-color: #c3cbdc;\\n\\t\\tbackground-image: linear-gradient(147deg, #c3cbdc 0%, #edf1f4 74%);\\n\\t\\tborder-radius: 5px;\\n\\t\\tpadding: 10px;\\n\\t\\tfloat: left;\\n\\t\\tmargin-right: 20px;\\n\\t}\\n\\n\\t.content {\\n\\t\\twidth: calc(100% - 240px);\\n\\t\\tfloat: left;\\n\\t}\\n\\n\\t.project-item {\\n\\t\\tbackground-color: #c3cbdc;\\n\\t\\tbackground-image: linear-gradient(147deg, #c3cbdc 0%, #edf1f4 74%);\\n\\t\\tborder-radius: 5px;\\n\\t\\tmargin-bottom: 20px;\\n\\t\\tpadding: 10px;\\n\\t}\\n\\n\\t.project-item h2 {\\n\\t\\tfont-size: 1.8em;\\n\\t}\\n\\n\\t.project-item p {\\n\\t\\tfont-size: 1.2em;\\n\\t}\\n\\t.categories {\\n\\t\\tlist-style-type: none;\\n\\t}\\n\\t.clearfix::after {\\n\\t\\tcontent: '';\\n\\t\\tclear: both;\\n\\t\\tdisplay: table;\\n\\t}\\n\\n\\t.grid-wrapper {\\n\\t\\tposition: absolute;\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t\\tleft: 0;\\n\\t\\tbottom: 0px;\\n\\t\\tperspective: 200px;\\n\\t\\tz-index: 0;\\n\\t\\toverflow: hidden;\\n\\t}\\n\\n\\t.blog-container {\\n\\t\\tbackground-image: url($lib/assets/MaxthonImages/MELT_FRAME.png);\\n\\t\\tbackground-repeat: no-repeat;\\n\\t\\tbackground-size: contain;\\n\\t\\tmargin: -60px auto 0;\\n\\t\\twidth: 100%;\\n\\t\\tmax-width: 800px;\\n\\t\\theight: 600px;\\n\\t\\tpadding: 0px 100px 0px 100px;\\n\\t\\tposition: relative;\\n\\t\\tz-index: 2;\\n\\t\\toverflow: hidden;\\n\\t\\tdisplay: flex;\\n\\t\\tjustify-content: center;\\n\\t\\talign-items: center;\\n\\t}\\n\\n\\t.blog {\\n\\t\\twidth: 600px;\\n\\t\\theight: 330px;\\n\\t\\toverflow-y: auto;\\n\\t\\tpadding: 0px;\\n\\t\\tbox-sizing: border-box;\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tpadding-bottom: 20px;\\n\\t}\\n\\n\\t.glass-overlay {\\n\\t\\tposition: absolute;\\n\\t\\ttop: 17%;\\n\\t\\tleft: 17%;\\n\\t\\twidth: 630px;\\n\\t\\theight: 350px;\\n\\t\\tbackground: rgba(255, 255, 255, 0.2);\\n\\t\\tbackdrop-filter: blur(5px);\\n\\t\\tborder-radius: 45px;\\n\\t\\tbox-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);\\n\\t\\tpointer-events: none;\\n\\t\\tpadding: 7px 12px 8px 12px;\\n\\t\\tz-index: 1;\\n\\t\\ttext-align: center;\\n\\t}\\n\\n\\t.loader {\\n\\t\\tsize: 10rem;\\n\\t\\tmargin-top: 70px;\\n\\t}\\n\\t.blink {\\n\\t\\tanimation: blink-animation 1s steps(5, start) infinite;\\n\\t\\t-webkit-animation: blink-animation 1s steps(5, start) infinite;\\n\\t}\\n\\n\\t@keyframes blink-animation {\\n\\t\\tto {\\n\\t\\t\\tvisibility: hidden;\\n\\t\\t}\\n\\t}\\n\\n\\t.grid {\\n\\t\\tposition: absolute;\\n\\t\\ttop: 0;\\n\\t\\tleft: 0;\\n\\t\\tright: 0;\\n\\t\\tbottom: 0;\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t\\tmargin-top: -50px;\\n\\t\\ttransform: rotateX(45deg);\\n\\t}\\n\\n\\t.floating {\\n\\t\\tanimation-name: floating;\\n\\t\\tanimation-duration: 3s;\\n\\t\\tanimation-iteration-count: infinite;\\n\\t\\tanimation-timing-function: ease-in-out;\\n\\t\\tmargin-left: 30px;\\n\\t\\tmargin-top: 5px;\\n\\t}\\n\\n\\t@keyframes floating {\\n\\t\\t0% {\\n\\t\\t\\ttransform: translate(0, 0px);\\n\\t\\t}\\n\\t\\t50% {\\n\\t\\t\\ttransform: translate(0, 15px);\\n\\t\\t}\\n\\t\\t100% {\\n\\t\\t\\ttransform: translate(0, -0px);\\n\\t\\t}\\n\\t}\\n\\n\\t.line {\\n\\t\\tposition: absolute;\\n\\t\\tbackground: rgba(155, 158, 217, 0.35); /* Changed to a more icy blue color */\\n\\t\\tbackface-visibility: hidden;\\n\\t}\\n\\n\\t.vertical .line {\\n\\t\\ttop: 0;\\n\\t\\tleft: 0;\\n\\t\\tbottom: 0;\\n\\t\\twidth: 5px;\\n\\t\\tbackground: linear-gradient(\\n\\t\\t\\tto bottom,\\n\\t\\t\\trgba(255, 255, 255, 0),\\n\\t\\t\\trgba(155, 158, 217, 0.35)\\n\\t\\t); /* Changed to a more icy blue color */\\n\\t}\\n\\t.vertical .line:nth-child(1) {\\n\\t\\tleft: 10%;\\n\\t}\\n\\t.vertical .line:nth-child(2) {\\n\\t\\tleft: 20%;\\n\\t}\\n\\t.vertical .line:nth-child(3) {\\n\\t\\tleft: 30%;\\n\\t}\\n\\t.vertical .line:nth-child(4) {\\n\\t\\tleft: 40%;\\n\\t}\\n\\t.vertical .line:nth-child(5) {\\n\\t\\tleft: 50%;\\n\\t}\\n\\t.vertical .line:nth-child(6) {\\n\\t\\tleft: 60%;\\n\\t}\\n\\t.vertical .line:nth-child(7) {\\n\\t\\tleft: 70%;\\n\\t}\\n\\t.vertical .line:nth-child(8) {\\n\\t\\tleft: 80%;\\n\\t}\\n\\t.vertical .line:nth-child(9) {\\n\\t\\tleft: 90%;\\n\\t}\\n\\t.vertical .line:nth-child(10) {\\n\\t\\tleft: 100%;\\n\\t\\tmargin-left: -1px;\\n\\t}\\n\\n\\t.horizontal .line {\\n\\t\\ttop: 0;\\n\\t\\tleft: 0;\\n\\t\\tright: 0;\\n\\t\\theight: 5px;\\n\\t\\tz-index: 2;\\n\\t}\\n\\n\\t.horizontal .line:nth-child(1) {\\n\\t\\ttop: 10%;\\n\\t\\topacity: 0.2;\\n\\t}\\n\\t.horizontal .line:nth-child(2) {\\n\\t\\ttop: 20%;\\n\\t\\topacity: 0.3;\\n\\t}\\n\\t.horizontal .line:nth-child(3) {\\n\\t\\ttop: 30%;\\n\\t\\topacity: 0.4;\\n\\t}\\n\\t.horizontal .line:nth-child(4) {\\n\\t\\ttop: 40%;\\n\\t\\topacity: 0.5;\\n\\t}\\n\\t.horizontal .line:nth-child(5) {\\n\\t\\ttop: 50%;\\n\\t\\topacity: 0.6;\\n\\t}\\n\\t.horizontal .line:nth-child(6) {\\n\\t\\ttop: 60%;\\n\\t\\topacity: 0.7;\\n\\t}\\n\\t.horizontal .line:nth-child(7) {\\n\\t\\ttop: 70%;\\n\\t\\topacity: 0.8;\\n\\t}\\n\\t.horizontal .line:nth-child(8) {\\n\\t\\ttop: 80%;\\n\\t\\topacity: 0.9;\\n\\t}\\n\\t.horizontal .line:nth-child(9) {\\n\\t\\ttop: 90%;\\n\\t\\topacity: 0.95;\\n\\t}\\n\\t.horizontal .line:nth-child(10) {\\n\\t\\ttop: 100%;\\n\\t\\tmargin-top: -1px;\\n\\t\\topacity: 1;\\n\\t}\\n\\t.horizontal .line:nth-child(11) {\\n\\t\\topacity: 0.05;\\n\\t}\\n\\n\\t.dot {\\n\\t\\tposition: absolute;\\n\\t\\tbackground: #57c1e8;\\n\\t\\twidth: 5px;\\n\\t\\theight: 5px;\\n\\t\\ttop: 100%;\\n\\t\\tborder-radius: 5px;\\n\\t\\tbox-shadow: 0 0 3px #fff;\\n\\t\\tbackface-visibility: hidden;\\n\\t}\\n\\n\\t.dot:nth-child(1) {\\n\\t\\tleft: 10%;\\n\\t\\tanimation: moveDot 5s infinite;\\n\\t}\\n\\t.dot:nth-child(2) {\\n\\t\\tleft: 20%;\\n\\t\\tanimation: moveDot 20s infinite;\\n\\t}\\n\\t.dot:nth-child(3) {\\n\\t\\tleft: 30%;\\n\\t\\tanimation: moveDot 15s infinite;\\n\\t}\\n\\t.dot:nth-child(4) {\\n\\t\\tleft: 50%;\\n\\t\\tanimation: moveDot 30s infinite;\\n\\t}\\n\\t.dot:nth-child(5) {\\n\\t\\tleft: 60%;\\n\\t\\tanimation: moveDot 12s infinite;\\n\\t}\\n\\t.dot:nth-child(6) {\\n\\t\\tleft: 80%;\\n\\t\\tanimation: moveDot 6s infinite;\\n\\t}\\n\\t.dot:nth-child(7) {\\n\\t\\tleft: 90%;\\n\\t\\tanimation: moveDot 8s infinite;\\n\\t}\\n\\n\\t@keyframes moveDot {\\n\\t\\t0% {\\n\\t\\t\\ttop: 100%;\\n\\t\\t\\topacity: 1;\\n\\t\\t}\\n\\t\\t100% {\\n\\t\\t\\ttop: 0%;\\n\\t\\t\\topacity: 0;\\n\\t\\t}\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAmHC,QAAQ,sEAAsE,CAE9E,UAAW,CACV,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,kCAAkC,CAAC,OAAO,UAAU,CAC1D,CAEA,UAAW,CACV,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,oCAAoC,CAAC,OAAO,UAAU,CAC5D,CAEA,sCAAS,CACR,gBAAgB,CAAE,OAAO,CACzB,UAAU,CAAE,gBAAgB,EAAE,CAAC,GAAG,CAAC,CAAC,OAAO,CAAC,CAAC,OAAO,CAAC,CACrD,UAAU,CAAE,KAAK,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CACnD,WAAW,CAAE,WAAW,CAAC,CAAC,OAAO,CACjC,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,CAAC,CACT,OAAO,CAAE,CAAC,CACV,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,KAAK,CACjB,QAAQ,CAAE,MAAM,CAChB,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MACX,CAEA,wCAAW,CACV,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,OAAO,CAAE,GAAG,CACZ,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAClB,CAEA,oCAAO,CACN,KAAK,CAAE,KAAK,CACZ,UAAU,CAAE,MAAM,CAClB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,GAAG,CACR,IAAI,CAAE,GAAG,CACT,SAAS,CAAE,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,CAChC,UAAU,CAAE,MAAM,CAClB,OAAO,CAAE,CACV,CACA,sBAAO,CAAC,kBAAI,CACX,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,KACR,CACA,gCAAG,CACF,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,GAAG,CACd,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,CAAC,CACV,gBAAgB,CAAE,8DAA8D,CAChF,iBAAiB,CAAE,MAAM,CACzB,uBAAuB,CAAE,IAAI,CAC7B,eAAe,CAAE,IAAI,CACrB,uBAAuB,CAAE,WAC1B,CAEA,gCAAG,CACF,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,GAAG,CACd,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,CAAC,CACV,gBAAgB,CAAE,8DAA8D,CAChF,iBAAiB,CAAE,MAAM,CACzB,uBAAuB,CAAE,IAAI,CAC7B,eAAe,CAAE,IAAI,CACrB,uBAAuB,CAAE,WAAW,CACpC,UAAU,CAAE,MAAM,CAClB,cAAc,CAAE,mBAAI,CAAC,CAAC,oBAAK,CAC3B,yBAAyB,CAAE,MAAM,CACjC,yBAAyB,CAAE,QAAQ,CACnC,kBAAkB,CAAE,EAAE,CACtB,eAAe,CAAE,WAAW,CAC5B,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,YACV,CAEA,gCAAE,QAAQ,CACV,gCAAE,OAAQ,CACT,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,KAAK,CACd,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,GAAG,CAAE,CAAC,CACN,SAAS,CAAE,QAAQ,MAAM,CAAC,CAC1B,gBAAgB,CAAE,CAAC,CAAC,GAAG,CACvB,uBAAuB,CAAE,IAAI,CAC7B,eAAe,CAAE,IAAI,CACrB,uBAAuB,CAAE,WAC1B,CAEA,gCAAE,OAAQ,CACT,SAAS,CAAE,QAAQ,OAAO,CAAC,CAC3B,gBAAgB,CAAE,IAAI,CAAC,GACxB,CAEA,WAAW,mBAAK,CACf,IAAK,CACJ,SAAS,CAAE,QAAQ,IAAI,CACxB,CACA,EAAG,CACF,SAAS,CAAE,QAAQ,OAAO,CAC3B,CACD,CAEA,WAAW,oBAAM,CAChB,EAAG,CACF,WAAW,CACV,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,OAAO,CAAC;AACpB,IAAI,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,OAAO,CAAC;AACrB,IAAI,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,OACX,CACA,GAAI,CACH,WAAW,CACV,GAAG,CAAC,CAAC,CAAC,GAAG,CAAC,OAAO,CAAC;AACtB,IAAI,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,OAAO,CAAC;AACvB,IAAI,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,OAAO,CAAC;AACvB,IAAI,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,OACb,CACA,GAAI,CACH,WAAW,CACV,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,OAAO,CAAC;AACpB,IAAI,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,OAAO,CAAC;AACrB,IAAI,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,OACX,CACA,GAAI,CACH,WAAW,CACV,IAAI,CAAC,CAAC,CAAC,GAAG,CAAC,OAAO,CAAC;AACvB,IAAI,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,OAAO,CAAC;AACxB,IAAI,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,OAAO,CAAC;AACxB,IAAI,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,OACd,CACA,IAAK,CACJ,WAAW,CACV,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,OAAO,CAAC;AACpB,IAAI,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,OAAO,CAAC;AACrB,IAAI,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,OACX,CACD,CAEA,qCAAQ,CACP,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,YAAY,CACrB,QAAQ,CAAE,QACX,CAEA,qCAAQ,CACP,gBAAgB,CAAE,WAAW,CAC7B,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,MAAM,CAClB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,IACR,CAEA,mCAAM,CACL,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,YAAY,CAC7B,OAAO,CAAE,IAAI,CACb,aAAa,CAAE,IAChB,CAEA,yCAAY,CACX,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,EAAE,CACP,IAAI,CAAE,GAAG,CACT,SAAS,CAAE,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,CAChC,OAAO,CAAE,EACV,CAEA,2CAAc,CACb,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,EACV,CAEA,sCAAS,CACR,KAAK,CAAE,KAAK,CACZ,gBAAgB,CAAE,OAAO,CACzB,gBAAgB,CAAE,gBAAgB,MAAM,CAAC,CAAC,OAAO,CAAC,EAAE,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,CAClE,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,IAAI,CACX,YAAY,CAAE,IACf,CAEA,sCAAS,CACR,KAAK,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,KAAK,CAAC,CACzB,KAAK,CAAE,IACR,CAEA,2CAAc,CACb,gBAAgB,CAAE,OAAO,CACzB,gBAAgB,CAAE,gBAAgB,MAAM,CAAC,CAAC,OAAO,CAAC,EAAE,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,CAClE,aAAa,CAAE,GAAG,CAClB,aAAa,CAAE,IAAI,CACnB,OAAO,CAAE,IACV,CAEA,4BAAa,CAAC,iBAAG,CAChB,SAAS,CAAE,KACZ,CAEA,4BAAa,CAAC,gBAAE,CACf,SAAS,CAAE,KACZ,CACA,yCAAY,CACX,eAAe,CAAE,IAClB,CACA,uCAAS,OAAQ,CAChB,OAAO,CAAE,EAAE,CACX,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,KACV,CAEA,2CAAc,CACb,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,IAAI,CAAE,CAAC,CACP,MAAM,CAAE,GAAG,CACX,WAAW,CAAE,KAAK,CAClB,OAAO,CAAE,CAAC,CACV,QAAQ,CAAE,MACX,CAEA,6CAAgB,CACf,gBAAgB,CAAE,6CAA6C,CAC/D,iBAAiB,CAAE,SAAS,CAC5B,eAAe,CAAE,OAAO,CACxB,MAAM,CAAE,KAAK,CAAC,IAAI,CAAC,CAAC,CACpB,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,KAAK,CACb,OAAO,CAAE,GAAG,CAAC,KAAK,CAAC,GAAG,CAAC,KAAK,CAC5B,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,CAAC,CACV,QAAQ,CAAE,MAAM,CAChB,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MACd,CAEA,mCAAM,CACL,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,CACb,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,GAAG,CACZ,UAAU,CAAE,UAAU,CACtB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,cAAc,CAAE,IACjB,CAEA,4CAAe,CACd,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,GAAG,CACR,IAAI,CAAE,GAAG,CACT,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,CACb,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CACpC,eAAe,CAAE,KAAK,GAAG,CAAC,CAC1B,aAAa,CAAE,IAAI,CACnB,UAAU,CAAE,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACxC,cAAc,CAAE,IAAI,CACpB,OAAO,CAAE,GAAG,CAAC,IAAI,CAAC,GAAG,CAAC,IAAI,CAC1B,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,MACb,CAEA,qCAAQ,CACP,IAAI,CAAE,KAAK,CACX,UAAU,CAAE,IACb,CACA,oCAAO,CACN,SAAS,CAAE,8BAAe,CAAC,EAAE,CAAC,MAAM,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,QAAQ,CACtD,iBAAiB,CAAE,8BAAe,CAAC,EAAE,CAAC,MAAM,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,QACvD,CAEA,WAAW,8BAAgB,CAC1B,EAAG,CACF,UAAU,CAAE,MACb,CACD,CAEA,mCAAM,CACL,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,CAAC,CACT,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,KAAK,CACjB,SAAS,CAAE,QAAQ,KAAK,CACzB,CAEA,uCAAU,CACT,cAAc,CAAE,uBAAQ,CACxB,kBAAkB,CAAE,EAAE,CACtB,yBAAyB,CAAE,QAAQ,CACnC,yBAAyB,CAAE,WAAW,CACtC,WAAW,CAAE,IAAI,CACjB,UAAU,CAAE,GACb,CAEA,WAAW,uBAAS,CACnB,EAAG,CACF,SAAS,CAAE,UAAU,CAAC,CAAC,CAAC,GAAG,CAC5B,CACA,GAAI,CACH,SAAS,CAAE,UAAU,CAAC,CAAC,CAAC,IAAI,CAC7B,CACA,IAAK,CACJ,SAAS,CAAE,UAAU,CAAC,CAAC,CAAC,IAAI,CAC7B,CACD,CAEA,mCAAM,CACL,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,IAAI,CAAC,CACrC,mBAAmB,CAAE,MACtB,CAEA,wBAAS,CAAC,oBAAM,CACf,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,MAAM,CAAE,CAAC,CACT,KAAK,CAAE,GAAG,CACV,UAAU,CAAE;AACd,GAAG,EAAE,CAAC,MAAM,CAAC;AACb,GAAG,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC;AAC1B,GAAG,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,IAAI,CAAC;AAC5B,GACC,CACA,wBAAS,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC5B,IAAI,CAAE,GACP,CACA,wBAAS,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC5B,IAAI,CAAE,GACP,CACA,wBAAS,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC5B,IAAI,CAAE,GACP,CACA,wBAAS,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC5B,IAAI,CAAE,GACP,CACA,wBAAS,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC5B,IAAI,CAAE,GACP,CACA,wBAAS,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC5B,IAAI,CAAE,GACP,CACA,wBAAS,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC5B,IAAI,CAAE,GACP,CACA,wBAAS,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC5B,IAAI,CAAE,GACP,CACA,wBAAS,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC5B,IAAI,CAAE,GACP,CACA,wBAAS,CAAC,oBAAK,WAAW,EAAE,CAAE,CAC7B,IAAI,CAAE,IAAI,CACV,WAAW,CAAE,IACd,CAEA,0BAAW,CAAC,oBAAM,CACjB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,GAAG,CACX,OAAO,CAAE,CACV,CAEA,0BAAW,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC9B,GAAG,CAAE,GAAG,CACR,OAAO,CAAE,GACV,CACA,0BAAW,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC9B,GAAG,CAAE,GAAG,CACR,OAAO,CAAE,GACV,CACA,0BAAW,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC9B,GAAG,CAAE,GAAG,CACR,OAAO,CAAE,GACV,CACA,0BAAW,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC9B,GAAG,CAAE,GAAG,CACR,OAAO,CAAE,GACV,CACA,0BAAW,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC9B,GAAG,CAAE,GAAG,CACR,OAAO,CAAE,GACV,CACA,0BAAW,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC9B,GAAG,CAAE,GAAG,CACR,OAAO,CAAE,GACV,CACA,0BAAW,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC9B,GAAG,CAAE,GAAG,CACR,OAAO,CAAE,GACV,CACA,0BAAW,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC9B,GAAG,CAAE,GAAG,CACR,OAAO,CAAE,GACV,CACA,0BAAW,CAAC,oBAAK,WAAW,CAAC,CAAE,CAC9B,GAAG,CAAE,GAAG,CACR,OAAO,CAAE,IACV,CACA,0BAAW,CAAC,oBAAK,WAAW,EAAE,CAAE,CAC/B,GAAG,CAAE,IAAI,CACT,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,CACV,CACA,0BAAW,CAAC,oBAAK,WAAW,EAAE,CAAE,CAC/B,OAAO,CAAE,IACV,CAEA,kCAAK,CACJ,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,OAAO,CACnB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,GAAG,CAAE,IAAI,CACT,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,CACxB,mBAAmB,CAAE,MACtB,CAEA,kCAAI,WAAW,CAAC,CAAE,CACjB,IAAI,CAAE,GAAG,CACT,SAAS,CAAE,sBAAO,CAAC,EAAE,CAAC,QACvB,CACA,kCAAI,WAAW,CAAC,CAAE,CACjB,IAAI,CAAE,GAAG,CACT,SAAS,CAAE,sBAAO,CAAC,GAAG,CAAC,QACxB,CACA,kCAAI,WAAW,CAAC,CAAE,CACjB,IAAI,CAAE,GAAG,CACT,SAAS,CAAE,sBAAO,CAAC,GAAG,CAAC,QACxB,CACA,kCAAI,WAAW,CAAC,CAAE,CACjB,IAAI,CAAE,GAAG,CACT,SAAS,CAAE,sBAAO,CAAC,GAAG,CAAC,QACxB,CACA,kCAAI,WAAW,CAAC,CAAE,CACjB,IAAI,CAAE,GAAG,CACT,SAAS,CAAE,sBAAO,CAAC,GAAG,CAAC,QACxB,CACA,kCAAI,WAAW,CAAC,CAAE,CACjB,IAAI,CAAE,GAAG,CACT,SAAS,CAAE,sBAAO,CAAC,EAAE,CAAC,QACvB,CACA,kCAAI,WAAW,CAAC,CAAE,CACjB,IAAI,CAAE,GAAG,CACT,SAAS,CAAE,sBAAO,CAAC,EAAE,CAAC,QACvB,CAEA,WAAW,sBAAQ,CAClB,EAAG,CACF,GAAG,CAAE,IAAI,CACT,OAAO,CAAE,CACV,CACA,IAAK,CACJ,GAAG,CAAE,EAAE,CACP,OAAO,CAAE,CACV,CACD"}`
};
const Projects = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const bubbles = Array.from({ length: 20 });
  $$result.css.add(css$9);
  return `<div class="wrapper svelte-1xy50jt"><div class="grid-wrapper svelte-1xy50jt" data-svelte-h="svelte-1weagi5"><div class="grid svelte-1xy50jt"><div class="vertical svelte-1xy50jt"><div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div></div> <div class="dots"><div class="dot svelte-1xy50jt"></div> <div class="dot svelte-1xy50jt"></div> <div class="dot svelte-1xy50jt"></div> <div class="dot svelte-1xy50jt"></div> <div class="dot svelte-1xy50jt"></div> <div class="dot svelte-1xy50jt"></div> <div class="dot svelte-1xy50jt"></div></div> <div class="horizontal svelte-1xy50jt"><div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div> <div class="line svelte-1xy50jt"></div></div></div></div> <div class="glassbuble svelte-1xy50jt" data-svelte-h="svelte-1jgz65j"><img${add_attribute("src", glassBuble, 0)} alt="bubbles"></div> <div class="container svelte-1xy50jt">${each(bubbles, (_, i) => {
  ...
  })} <div class="header floating svelte-1xy50jt" data-svelte-h="svelte-14hmrtx"><div class="title svelte-1xy50jt"><h1 class="svelte-1xy50jt">Projects</h1></div> <div><img${add_attribute("src", Y2Kaesthetic, 0)} alt="y2k aesthetic" class="svelte-1xy50jt"></div></div> <div class="blog-container svelte-1xy50jt" data-svelte-h="svelte-1691ne8"><div class="glass-overlay svelte-1xy50jt"><div class="loader svelte-1xy50jt"><span>𓆩.⚝.𓆪</span> <div><h4 class="svelte-1xy50jt">loading</h4></div> <span class="blink svelte-1xy50jt">✧</span> <span class="blink svelte-1xy50jt">✧</span> <span class="blink svelte-1xy50jt">✧</span></div></div> <div class="blog svelte-1xy50jt"><div class="menu svelte-1xy50jt"><a href="/"><img${add_attribute("src", starLink, 0)} alt="star link"></a> <a href="/about"><img${add_attribute("src", starLink, 0)} alt="star link"></a> <a href="/contact"><img${add_attribute("src", starLink, 0)} alt="star link"></a></div> <div class="clearfix svelte-1xy50jt"><div class="sidebar svelte-1xy50jt"><h2>Categories</h2> <ul class="categories svelte-1xy50jt"><li>Web Design</li> <li>Graphic Design</li> <li>Development</li></ul></div> <div class="content svelte-1xy50jt"><div class="project-item svelte-1xy50jt"><h2 class="svelte-1xy50jt">Travel Site</h2> <p class="svelte-1xy50jt">Java and MySQL on the back end. Angular front-end.</p></div> <div class="project-item svelte-1xy50jt"><h2 class="svelte-1xy50jt">Booking Platform</h2> <p class="svelte-1xy50jt">Django and SQLlite backend. The front end is Svelte.</p></div> <div class="project-item svelte-1xy50jt"><h2 class="svelte-1xy50jt">Hexwood Hunt (Game)</h2> <p class="svelte-1xy50jt">No framerworks, just JavaScript, HTML and CSS.</p></div> <div class="project-item svelte-1xy50jt"><h2 class="svelte-1xy50jt">Windows XP Portfolio</h2> <p class="svelte-1xy50jt">Sveltekit, other small projects called in for a more realistic experience.</p></div></div></div></div></div> <div class="footer svelte-1xy50jt" data-svelte-h="svelte-oqmztz">© 2024 Full Stack 🥞 . All rights reserved.</div></div> <div class="glasscyclone svelte-1xy50jt" data-svelte-h="svelte-15n3zkl"><img${add_attribute("src", glassCyclone, 0)} alt="cyclone"></div> </div>`;
});
...
const soundIcon = "data:image/png;base64,";
const WindowIcon = "data:image/png;base64,";
const start2 = "/_app/immutable/assets/starttext.Terj2S8a.png";
const css$2 = {
  code: ".taskbar.svelte-fsg4bz.svelte-fsg4bz{position:fixed;bottom:0;left:0;right:0;background:linear-gradient(\n			to bottom,\n			#1868ce 0%,\n			#0e60cb 12%,\n			#0e60cb 20%,\n			#1164cf 32%,\n			#1667cf 33%,\n			#1b6cd3 47%,\n			#1e70d9 54%,\n			#2476dc 60%,\n			#297ae0 65%,\n			#3482e3 77%,\n			#3786e5 79%,\n			#428ee9 90%,\n			#4791eb 100%\n		);width:100vw;height:36px;display:flex;justify-content:space-between;align-items:center;padding:0 0px}.taskbar.svelte-fsg4bz.svelte-fsg4bz:before{content:'';display:block;position:absolute;top:1px;left:0;width:100%;height:3px;background:linear-gradient(\n			to right,\n			transparent 0,\n			rgb(255, 255, 255, 0.3) 1%,\n			rgb(255, 255, 255, 0.5) 2%,\n			rgb(255, 255, 255, 0.5) 95%,\n			rgb(255, 255, 255, 0.3) 98%,\n			rgb(255, 255, 255, 0.2) 99%,\n			transparent 100%\n		);box-shadow:inset 0 -1px 1px #0e60cb;z-index:0}.taskbar__start-section.svelte-fsg4bz.svelte-fsg4bz{display:flex;align-items:center;justify-content:center;height:100%;z-index:1}.taskbar__start.svelte-fsg4bz.svelte-fsg4bz{width:105px;height:100%;color:white;font-weight:bold;font-size:1.1rem;font-style:italic;border:none;border-radius:0px 15px 17px 0px;box-shadow:0px 2px 4px rgba(0, 0, 0, 0.4);background:linear-gradient(to bottom, #67ae55, #578843);display:flex;align-items:center;position:absolute;left:0}.taskbar__start.svelte-fsg4bz.svelte-fsg4bz::before{content:'';position:absolute;top:0;left:0;width:100%;height:55%;background:linear-gradient(\n			to bottom,\n			rgba(255, 255, 255, 0.4) 0%,\n			rgba(255, 255, 255, 0.2) 50%,\n			rgba(255, 255, 255, 0) 100%\n		);opacity:0.8;pointer-events:none}.taskbar__start.svelte-fsg4bz.svelte-fsg4bz::after{content:'';position:absolute;bottom:0;left:0;width:100%;height:3px;background:linear-gradient(to right, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.1) 100%)}.taskbar__windowicon.svelte-fsg4bz.svelte-fsg4bz{margin-left:12px;width:20px;height:20px;display:flex}.taskbar__start--logo.svelte-fsg4bz.svelte-fsg4bz{margin-top:5px;width:50px}#start-menu.svelte-fsg4bz.svelte-fsg4bz{position:absolute;bottom:36px;left:0;width:400px;background-color:transparent;border:none;padding:0px;z-index:1000}.taskbar__time-section.svelte-fsg4bz.svelte-fsg4bz{display:flex;height:106%;justify-content:space-between;align-items:center;background-color:#0b77e9;flex-shrink:0;background:linear-gradient(\n			to bottom,\n			#0c59b9 1%,\n			#139ee9 6%,\n			#18b5f2 10%,\n			#139beb 14%,\n			#1290e8 19%,\n			#0d8dea 63%,\n			#0d9ff1 81%,\n			#0f9eed 88%,\n			#119be9 91%,\n			#1392e2 94%,\n			#137ed7 97%,\n			#095bc9 100%\n		);border-left:1px solid #1042af;box-shadow:inset 1px 0 1px #18bbff;padding:0 0px;margin-left:0px;z-index:1;position:absolute;right:0}#time-options.svelte-fsg4bz.svelte-fsg4bz{margin-left:10px;color:#fff;font-size:14px;font-weight:normal;text-shadow:none}#time-options.svelte-fsg4bz span.svelte-fsg4bz{margin-right:20px}.taskbar__icons.svelte-fsg4bz.svelte-fsg4bz{display:flex;align-items:center;margin-left:15px;justify-content:space-between}.taskbar__icons.svelte-fsg4bz img.svelte-fsg4bz{width:20px;height:20px}.taskbar__apps.svelte-fsg4bz.svelte-fsg4bz{display:flex;flex-direction:row;align-items:center;position:absolute;left:100px;margin-left:10px;overflow:hidden;width:calc(90% - 20px)}.taskbar__app.svelte-fsg4bz.svelte-fsg4bz{display:flex;align-items:center;border-radius:3px;padding:4px 56px 4px 0px;min-width:20px;border:1px solid #003c74;background:#3576f3;color:white;font-size:14px;cursor:pointer;outline:none;flex-shrink:1;flex-basis:175px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.taskbar__app.active.svelte-fsg4bz.svelte-fsg4bz{background:#2d5daf;box-shadow:0px 3px 0px rgba(0, 0, 0, 0.3);border-left:2px solid #0b2042;border-top:2px solid #0b2042;border-right:#003c74 1px solid;border-bottom:#003c74 1px solid}.taskbar__app.svelte-fsg4bz img.svelte-fsg4bz{width:16px;height:16px;margin-right:5px;margin-left:5px}.taskbar__app.svelte-fsg4bz.svelte-fsg4bz:hover{background-color:#53a3ff}",
  map: `{"version":3,"file":"StartBar.svelte","sources":["StartBar.svelte"],"sourcesContent":["<script>\\n\\timport { onMount, onDestroy } from 'svelte';\\n\\timport { time } from '../stores/stores';\\n\\timport { appState, restoreApp, focusApp, removeApp } from '../stores/appState';\\n\\timport StartBarMenu from './StarBarMenu.svelte';\\n\\timport WindowIcon from '$lib/assets/windowsIcons/Windowslogo.png';\\n\\timport start from '$lib/assets/windowsIcons/starttext.png';\\n\\timport soundIcon from '$lib/assets/windowsIcons/690(16x16).png';\\n\\n\\tlet startMenuOpen = false;\\n\\tlet startMenu;\\n\\n\\tconst formatter = new Intl.DateTimeFormat('en', {\\n\\t\\thour12: true,\\n\\t\\thour: 'numeric',\\n\\t\\tminute: '2-digit'\\n\\t});\\n\\n\\tfunction toggleStartMenu() {\\n\\t\\tstartMenuOpen = !startMenuOpen;\\n\\t\\tif (startMenuOpen) {\\n\\t\\t\\tdocument.addEventListener('click', handleClickOutside, true);\\n\\t\\t} else {\\n\\t\\t\\tdocument.removeEventListener('click', handleClickOutside, true);\\n\\t\\t}\\n\\t}\\n\\n\\tfunction handleClickOutside(event) {\\n\\t\\tif (startMenu && !startMenu.contains(event.target)) {\\n\\t\\t\\tstartMenuOpen = false;\\n\\t\\t\\tdocument.removeEventListener('click', handleClickOutside, true);\\n\\t\\t}\\n\\t}\\n\\n\\tfunction handleAppClick(id) {\\n\\t\\trestoreApp(id);\\n\\t\\tfocusApp(id);\\n\\t}\\n\\n\\tonMount(() => {\\n\\t\\treturn () => {\\n\\t\\t\\tdocument.removeEventListener('click', handleClickOutside, true);\\n\\t\\t};\\n\\t});\\n<\/script>\\n\\n<div class=\\"taskbar\\">\\n\\t<div class=\\"taskbar__start-section\\">\\n\\t\\t<button class=\\"taskbar__start\\" on:click={toggleStartMenu}>\\n\\t\\t\\t<div>\\n\\t\\t\\t\\t<img class=\\"taskbar__windowicon\\" src={WindowIcon} alt=\\" \\" />\\n\\t\\t\\t</div>\\n\\t\\t\\t<div><img class=\\"taskbar__start--logo\\" src={start} alt=\\"start\\" /></div>\\n\\t\\t</button>\\n\\t\\t{#if startMenuOpen}\\n\\t\\t\\t<div id=\\"start-menu\\" bind:this={startMenu}>\\n\\t\\t\\t\\t<StartBarMenu />\\n\\t\\t\\t</div>\\n\\t\\t{/if}\\n\\t\\t<div class=\\"taskbar__apps\\">\\n\\t\\t\\t{#each $appState.apps as app (app.id)}\\n\\t\\t\\t\\t<!-- svelte-ignore a11y-click-events-have-key-events -->\\n\\t\\t\\t\\t<!-- svelte-ignore a11y-no-static-element-interactions -->\\n\\t\\t\\t\\t<div\\n\\t\\t\\t\\t\\tclass=\\"taskbar__app {app.id === $appState.focusedAppId ? 'active' : ''}\\"\\n\\t\\t\\t\\t\\ton:click={() => handleAppClick(app.id)}\\n\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t<img src={app.header.icon} alt={app.header.title} />\\n\\t\\t\\t\\t\\t<span>{app.header.title}</span>\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t{/each}\\n\\t\\t</div>\\n\\t</div>\\n\\n\\t<div class=\\"taskbar__time-section\\">\\n\\t\\t<div class=\\"taskbar__icons\\"><img src={soundIcon} alt=\\"sound\\" /></div>\\n\\t\\t<div id=\\"time-options\\">\\n\\t\\t\\t<span>{formatter.format($time)}</span>\\n\\t\\t</div>\\n\\t</div>\\n</div>\\n\\n<style>\\n\\t.taskbar {\\n\\t\\tposition: fixed;\\n\\t\\tbottom: 0;\\n\\t\\tleft: 0;\\n\\t\\tright: 0;\\n\\t\\tbackground: linear-gradient(\\n\\t\\t\\tto bottom,\\n\\t\\t\\t#1868ce 0%,\\n\\t\\t\\t#0e60cb 12%,\\n\\t\\t\\t#0e60cb 20%,\\n\\t\\t\\t#1164cf 32%,\\n\\t\\t\\t#1667cf 33%,\\n\\t\\t\\t#1b6cd3 47%,\\n\\t\\t\\t#1e70d9 54%,\\n\\t\\t\\t#2476dc 60%,\\n\\t\\t\\t#297ae0 65%,\\n\\t\\t\\t#3482e3 77%,\\n\\t\\t\\t#3786e5 79%,\\n\\t\\t\\t#428ee9 90%,\\n\\t\\t\\t#4791eb 100%\\n\\t\\t);\\n\\t\\twidth: 100vw;\\n\\t\\theight: 36px;\\n\\t\\tdisplay: flex;\\n\\t\\tjustify-content: space-between;\\n\\t\\talign-items: center;\\n\\t\\tpadding: 0 0px;\\n\\t}\\n\\n\\t.taskbar:before {\\n\\t\\tcontent: '';\\n\\t\\tdisplay: block;\\n\\t\\tposition: absolute;\\n\\t\\ttop: 1px;\\n\\t\\tleft: 0;\\n\\t\\twidth: 100%;\\n\\t\\theight: 3px;\\n\\t\\tbackground: linear-gradient(\\n\\t\\t\\tto right,\\n\\t\\t\\ttransparent 0,\\n\\t\\t\\trgb(255, 255, 255, 0.3) 1%,\\n\\t\\t\\trgb(255, 255, 255, 0.5) 2%,\\n\\t\\t\\trgb(255, 255, 255, 0.5) 95%,\\n\\t\\t\\trgb(255, 255, 255, 0.3) 98%,\\n\\t\\t\\trgb(255, 255, 255, 0.2) 99%,\\n\\t\\t\\ttransparent 100%\\n\\t\\t);\\n\\t\\tbox-shadow: inset 0 -1px 1px #0e60cb;\\n\\t\\tz-index: 0;\\n\\t}\\n\\n\\t.taskbar__start-section {\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: center;\\n\\t\\tjustify-content: center;\\n\\t\\theight: 100%;\\n\\t\\tz-index: 1;\\n\\t}\\n\\n\\t.taskbar__start {\\n\\t\\twidth: 105px;\\n\\t\\theight: 100%;\\n\\t\\tcolor: white;\\n\\t\\tfont-weight: bold;\\n\\t\\tfont-size: 1.1rem;\\n\\t\\tfont-style: italic;\\n\\t\\tborder: none;\\n\\t\\tborder-radius: 0px 15px 17px 0px;\\n\\t\\tbox-shadow: 0px 2px 4px rgba(0, 0, 0, 0.4);\\n\\t\\tbackground: linear-gradient(to bottom, #67ae55, #578843);\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: center;\\n\\t\\tposition: absolute;\\n\\t\\tleft: 0;\\n\\t}\\n\\n\\t.taskbar__start::before {\\n\\t\\tcontent: '';\\n\\t\\tposition: absolute;\\n\\t\\ttop: 0;\\n\\t\\tleft: 0;\\n\\t\\twidth: 100%;\\n\\t\\theight: 55%;\\n\\t\\tbackground: linear-gradient(\\n\\t\\t\\tto bottom,\\n\\t\\t\\trgba(255, 255, 255, 0.4) 0%,\\n\\t\\t\\trgba(255, 255, 255, 0.2) 50%,\\n\\t\\t\\trgba(255, 255, 255, 0) 100%\\n\\t\\t);\\n\\t\\topacity: 0.8;\\n\\t\\tpointer-events: none;\\n\\t}\\n\\n\\t.taskbar__start::after {\\n\\t\\tcontent: '';\\n\\t\\tposition: absolute;\\n\\t\\tbottom: 0;\\n\\t\\tleft: 0;\\n\\t\\twidth: 100%;\\n\\t\\theight: 3px;\\n\\t\\tbackground: linear-gradient(to right, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.1) 100%);\\n\\t}\\n\\n\\t.taskbar__windowicon {\\n\\t\\tmargin-left: 12px;\\n\\t\\twidth: 20px;\\n\\t\\theight: 20px;\\n\\t\\tdisplay: flex;\\n\\t}\\n\\n\\t.taskbar__start--logo {\\n\\t\\tmargin-top: 5px;\\n\\t\\twidth: 50px;\\n\\t}\\n\\n\\t#start-menu {\\n\\t\\tposition: absolute;\\n\\t\\tbottom: 36px;\\n\\t\\tleft: 0;\\n\\t\\twidth: 400px;\\n\\t\\tbackground-color: transparent;\\n\\t\\tborder: none;\\n\\t\\tpadding: 0px;\\n\\t\\tz-index: 1000;\\n\\t}\\n\\n\\t.taskbar__time-section {\\n\\t\\tdisplay: flex;\\n\\t\\theight: 106%;\\n\\t\\tjustify-content: space-between;\\n\\t\\talign-items: center;\\n\\t\\tbackground-color: #0b77e9;\\n\\t\\tflex-shrink: 0;\\n\\t\\tbackground: linear-gradient(\\n\\t\\t\\tto bottom,\\n\\t\\t\\t#0c59b9 1%,\\n\\t\\t\\t#139ee9 6%,\\n\\t\\t\\t#18b5f2 10%,\\n\\t\\t\\t#139beb 14%,\\n\\t\\t\\t#1290e8 19%,\\n\\t\\t\\t#0d8dea 63%,\\n\\t\\t\\t#0d9ff1 81%,\\n\\t\\t\\t#0f9eed 88%,\\n\\t\\t\\t#119be9 91%,\\n\\t\\t\\t#1392e2 94%,\\n\\t\\t\\t#137ed7 97%,\\n\\t\\t\\t#095bc9 100%\\n\\t\\t);\\n\\t\\tborder-left: 1px solid #1042af;\\n\\t\\tbox-shadow: inset 1px 0 1px #18bbff;\\n\\t\\tpadding: 0 0px;\\n\\t\\tmargin-left: 0px;\\n\\t\\tz-index: 1;\\n\\t\\tposition: absolute;\\n\\t\\tright: 0;\\n\\t}\\n\\n\\t#time-options {\\n\\t\\tmargin-left: 10px;\\n\\t\\tcolor: #fff;\\n\\t\\tfont-size: 14px;\\n\\t\\tfont-weight: normal;\\n\\t\\ttext-shadow: none;\\n\\t}\\n\\n\\t#time-options span {\\n\\t\\tmargin-right: 20px;\\n\\t}\\n\\n\\t.taskbar__icons {\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: center;\\n\\t\\tmargin-left: 15px;\\n\\t\\tjustify-content: space-between;\\n\\t}\\n\\n\\t.taskbar__icons img {\\n\\t\\twidth: 20px;\\n\\t\\theight: 20px;\\n\\t}\\n\\n\\t.taskbar__apps {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: row;\\n\\t\\talign-items: center;\\n\\t\\tposition: absolute;\\n\\t\\tleft: 100px;\\n\\t\\tmargin-left: 10px;\\n\\t\\toverflow: hidden;\\n\\t\\twidth: calc(90% - 20px);\\n\\t}\\n\\n\\t.taskbar__app {\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: center;\\n\\t\\tborder-radius: 3px;\\n\\t\\tpadding: 4px 56px 4px 0px;\\n\\t\\tmin-width: 20px;\\n\\t\\tborder: 1px solid #003c74;\\n\\t\\tbackground: #3576f3;\\n\\t\\tcolor: white;\\n\\t\\tfont-size: 14px;\\n\\t\\tcursor: pointer;\\n\\t\\toutline: none;\\n\\t\\tflex-shrink: 1;\\n\\t\\tflex-basis: 175px;\\n\\t\\toverflow: hidden;\\n\\t\\ttext-overflow: ellipsis;\\n\\t\\twhite-space: nowrap;\\n\\t}\\n\\n\\t.taskbar__app.active {\\n\\t\\tbackground: #2d5daf;\\n\\t\\tbox-shadow: 0px 3px 0px rgba(0, 0, 0, 0.3);\\n\\t\\tborder-left: 2px solid #0b2042;\\n\\t\\tborder-top: 2px solid #0b2042;\\n\\t\\tborder-right: #003c74 1px solid;\\n\\t\\tborder-bottom: #003c74 1px solid;\\n\\t}\\n\\n\\t.taskbar__app img {\\n\\t\\twidth: 16px;\\n\\t\\theight: 16px;\\n\\t\\tmargin-right: 5px;\\n\\t\\tmargin-left: 5px;\\n\\t}\\n\\n\\t.taskbar__app:hover {\\n\\t\\tbackground-color: #53a3ff;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAmFC,oCAAS,CACR,QAAQ,CAAE,KAAK,CACf,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,CAAC,CACR,UAAU,CAAE;AACd,GAAG,EAAE,CAAC,MAAM,CAAC;AACb,GAAG,OAAO,CAAC,EAAE,CAAC;AACd,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,IAAI;AACf,GAAG,CACD,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,CAAC,CAAC,GACZ,CAEA,oCAAQ,OAAQ,CACf,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,KAAK,CACd,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,GAAG,CACR,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CACX,UAAU,CAAE;AACd,GAAG,EAAE,CAAC,KAAK,CAAC;AACZ,GAAG,WAAW,CAAC,CAAC,CAAC;AACjB,GAAG,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,EAAE,CAAC;AAC9B,GAAG,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,EAAE,CAAC;AAC9B,GAAG,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC;AAC/B,GAAG,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC;AAC/B,GAAG,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC;AAC/B,GAAG,WAAW,CAAC,IAAI;AACnB,GAAG,CACD,UAAU,CAAE,KAAK,CAAC,CAAC,CAAC,IAAI,CAAC,GAAG,CAAC,OAAO,CACpC,OAAO,CAAE,CACV,CAEA,mDAAwB,CACvB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,CACV,CAEA,2CAAgB,CACf,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,KAAK,CACZ,WAAW,CAAE,IAAI,CACjB,SAAS,CAAE,MAAM,CACjB,UAAU,CAAE,MAAM,CAClB,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,GAAG,CAAC,IAAI,CAAC,IAAI,CAAC,GAAG,CAChC,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC1C,UAAU,CAAE,gBAAgB,EAAE,CAAC,MAAM,CAAC,CAAC,OAAO,CAAC,CAAC,OAAO,CAAC,CACxD,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,CACP,CAEA,2CAAe,QAAS,CACvB,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CACX,UAAU,CAAE;AACd,GAAG,EAAE,CAAC,MAAM,CAAC;AACb,GAAG,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,EAAE,CAAC;AAC/B,GAAG,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC;AAChC,GAAG,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI;AAC9B,GAAG,CACD,OAAO,CAAE,GAAG,CACZ,cAAc,CAAE,IACjB,CAEA,2CAAe,OAAQ,CACtB,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CACX,UAAU,CAAE,gBAAgB,EAAE,CAAC,KAAK,CAAC,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,EAAE,CAAC,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,IAAI,CACrF,CAEA,gDAAqB,CACpB,WAAW,CAAE,IAAI,CACjB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IACV,CAEA,iDAAsB,CACrB,UAAU,CAAE,GAAG,CACf,KAAK,CAAE,IACR,CAEA,uCAAY,CACX,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,KAAK,CACZ,gBAAgB,CAAE,WAAW,CAC7B,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,GAAG,CACZ,OAAO,CAAE,IACV,CAEA,kDAAuB,CACtB,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,gBAAgB,CAAE,OAAO,CACzB,WAAW,CAAE,CAAC,CACd,UAAU,CAAE;AACd,GAAG,EAAE,CAAC,MAAM,CAAC;AACb,GAAG,OAAO,CAAC,EAAE,CAAC;AACd,GAAG,OAAO,CAAC,EAAE,CAAC;AACd,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,GAAG,CAAC;AACf,GAAG,OAAO,CAAC,IAAI;AACf,GAAG,CACD,WAAW,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CAC9B,UAAU,CAAE,KAAK,CAAC,GAAG,CAAC,CAAC,CAAC,GAAG,CAAC,OAAO,CACnC,OAAO,CAAE,CAAC,CAAC,GAAG,CACd,WAAW,CAAE,GAAG,CAChB,OAAO,CAAE,CAAC,CACV,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,CACR,CAEA,yCAAc,CACb,WAAW,CAAE,IAAI,CACjB,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,MAAM,CACnB,WAAW,CAAE,IACd,CAEA,2BAAa,CAAC,kBAAK,CAClB,YAAY,CAAE,IACf,CAEA,2CAAgB,CACf,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,WAAW,CAAE,IAAI,CACjB,eAAe,CAAE,aAClB,CAEA,6BAAe,CAAC,iBAAI,CACnB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IACT,CAEA,0CAAe,CACd,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,GAAG,CACnB,WAAW,CAAE,MAAM,CACnB,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,KAAK,CACX,WAAW,CAAE,IAAI,CACjB,QAAQ,CAAE,MAAM,CAChB,KAAK,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CACvB,CAEA,yCAAc,CACb,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,GAAG,CAAC,IAAI,CAAC,GAAG,CAAC,GAAG,CACzB,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CACzB,UAAU,CAAE,OAAO,CACnB,KAAK,CAAE,KAAK,CACZ,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,OAAO,CACf,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,CAAC,CACd,UAAU,CAAE,KAAK,CACjB,QAAQ,CAAE,MAAM,CAChB,aAAa,CAAE,QAAQ,CACvB,WAAW,CAAE,MACd,CAEA,aAAa,mCAAQ,CACpB,UAAU,CAAE,OAAO,CACnB,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC1C,WAAW,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CAC9B,UAAU,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CAC7B,YAAY,CAAE,OAAO,CAAC,GAAG,CAAC,KAAK,CAC/B,aAAa,CAAE,OAAO,CAAC,GAAG,CAAC,KAC5B,CAEA,2BAAa,CAAC,iBAAI,CACjB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,YAAY,CAAE,GAAG,CACjB,WAAW,CAAE,GACd,CAEA,yCAAa,MAAO,CACnB,gBAAgB,CAAE,OACnB"}`
};
const StartBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_time();
  return `<div class="taskbar svelte-fsg4bz"><div class="taskbar__start-section svelte-fsg4bz"><button class="taskbar__start svelte-fsg4bz" data-svelte-h="svelte-174ojj2"><div><img class="taskbar__windowicon svelte-fsg4bz"${add_attribute("src", WindowIcon, 0)} alt=" "></div> <div><img class="taskbar__start--logo svelte-fsg4bz"${add_attribute("src", start2, 0)} alt="start"></div></button> ${``} <div class="taskbar__apps svelte-fsg4bz">${each($appState.apps, (app) => {
    return `  <div class="${"taskbar__app " + escape(app.id === $appState.focusedAppId ? "active" : "", true) + " svelte-fsg4bz"}"><img${add_attribute("src", app.header.icon, 0)}${add_attribute("alt", app.header.title, 0)} class="svelte-fsg4bz"> <span>${escape(app.header.title)}</span> </div>`;
  })}</div></div> <div class="taskbar__time-section svelte-fsg4bz"><div class="taskbar__icons svelte-fsg4bz" data-svelte-h="svelte-jqcfgv"><img${add_attribute("src", soundIcon, 0)} alt="sound" class="svelte-fsg4bz"></div> <div id="time-options" class="svelte-fsg4bz"><span class="svelte-fsg4bz">${escape(formatter.format($time))}</span></div></div> </div>`;
});
const css$1 = {
  code: "#desktop.svelte-5obva5.svelte-5obva5{width:100%;height:calc(100% - 36px);overflow-y:hidden;background-color:none}.icon-draggable.svelte-5obva5.svelte-5obva5{cursor:none;touch-action:none;user-select:none}.icon.svelte-5obva5.svelte-5obva5{display:flex;flex-direction:column;width:100px;align-items:center;justify-content:center;margin:1% 0 3% 1%;padding:5px;border:2px solid transparent;border-radius:4px;box-sizing:border-box;cursor:pointer}.icon.svelte-5obva5 img.svelte-5obva5{width:54px;height:auto}.icon.svelte-5obva5 p.svelte-5obva5{position:absolute;line-height:1.5;text-align:center;text-shadow:1px 1px 2px black;margin-top:96px;font-size:12px;word-wrap:break-word;overflow:hidden;text-overflow:ellipsis;white-space:pre-line;max-width:100%}.icon.active.svelte-5obva5 p.svelte-5obva5{background-color:#0078d7;padding:1px 4px 1px 4px;color:#ffffff}.icon.active.svelte-5obva5 img.svelte-5obva5{opacity:0.75}.icon.svelte-5obva5.svelte-5obva5:focus{outline:none}.start-bar-container.svelte-5obva5.svelte-5obva5{position:fixed;bottom:0;left:0;right:0;z-index:1000}",
  map: `{"version":3,"file":"Desktop.svelte","sources":["Desktop.svelte"],"sourcesContent":["<script>\\n\\timport {\\n\\t\\ticonState,\\n\\t\\tappState,\\n\\t\\taddApp,\\n\\t\\tremoveApp,\\n\\t\\tminimizeApp,\\n\\t\\ttoggleMaximizeApp,\\n\\t\\tfocusApp\\n\\t} from './stores/appState';\\n\\timport { onMount, onDestroy } from 'svelte';\\n\\timport interact from 'interactjs';\\n\\timport StartBar from './StartBar/StartBar.svelte';\\n\\timport Window from './Window/Window.svelte';\\n\\n\\tfunction handleIconClick(clickedIcon) {\\n\\t\\ticonState.update((icons) => {\\n\\t\\t\\treturn icons.map((icon) => {\\n\\t\\t\\t\\ticon.active = icon.id === clickedIcon.id;\\n\\t\\t\\t\\treturn icon;\\n\\t\\t\\t});\\n\\t\\t});\\n\\t\\taddApp(clickedIcon.title);\\n\\t}\\n\\n\\tfunction closeWindow(id) {\\n\\t\\tremoveApp(id);\\n\\t}\\n\\n\\tfunction minimizeWindow(id) {\\n\\t\\tminimizeApp(id);\\n\\t}\\n\\n\\tfunction handleFocus(id) {\\n\\t\\tfocusApp(id);\\n\\t}\\n\\n\\tfunction formatTitle(title) {\\n\\t\\tconst words = title.split(' ');\\n\\t\\tif (words.length > 2) {\\n\\t\\t\\treturn \`\${words.slice(0, 2).join(' ')}<br>\${words.slice(2).join(' ')}\`;\\n\\t\\t}\\n\\t\\treturn title;\\n\\t}\\n\\n\\tfunction handleClickOutside(event) {\\n\\t\\tif (!event.target.closest('.icon')) {\\n\\t\\t\\ticonState.update((icons) => {\\n\\t\\t\\t\\treturn icons.map((icon) => {\\n\\t\\t\\t\\t\\ticon.active = false;\\n\\t\\t\\t\\t\\treturn icon;\\n\\t\\t\\t\\t});\\n\\t\\t\\t});\\n\\t\\t}\\n\\t}\\n\\n\\tonMount(() => {\\n\\t\\tdocument.addEventListener('click', handleClickOutside);\\n\\n\\t\\t// Set up draggable functionality for desktop icons\\n\\t\\tinteract('.icon-draggable').draggable({\\n\\t\\t\\tcursorChecker() {\\n\\t\\t\\t\\t// don't set a cursor for drag actions\\n\\t\\t\\t\\treturn null;\\n\\t\\t\\t},\\n\\t\\t\\tlisteners: {\\n\\t\\t\\t\\tmove(event) {\\n\\t\\t\\t\\t\\tconst target = event.target;\\n\\t\\t\\t\\t\\tconst x = (parseFloat(target.getAttribute('data-x')) || 0) + event.dx;\\n\\t\\t\\t\\t\\tconst y = (parseFloat(target.getAttribute('data-y')) || 0) + event.dy;\\n\\n\\t\\t\\t\\t\\ttarget.style.transform = \`translate(\${x}px, \${y}px)\`;\\n\\n\\t\\t\\t\\t\\ttarget.setAttribute('data-x', x);\\n\\t\\t\\t\\t\\ttarget.setAttribute('data-y', y);\\n\\t\\t\\t\\t}\\n\\t\\t\\t}\\n\\t\\t});\\n\\t});\\n\\n<\/script>\\n\\n\\t\\t<div id=\\"desktop\\">\\n\\t\\t\\t{#each $appState.apps as app (app.id)}\\n\\t\\t\\t\\t{#if !app.minimized}\\n\\t\\t\\t\\t\\t<Window\\n\\t\\t\\t\\t\\t\\twindow={app}\\n\\t\\t\\t\\t\\t\\tonClose={() => closeWindow(app.id)}\\n\\t\\t\\t\\t\\t\\tonMinimize={() => minimizeWindow(app.id)}\\n\\t\\t\\t\\t\\t\\tonFocus={() => handleFocus(app.id)}\\n\\t\\t\\t\\t\\t\\tdefaultSize={app.defaultSize}\\n\\t\\t\\t\\t\\t\\tdefaultOffset={app.defaultOffset}\\n\\t\\t\\t\\t\\t\\tzIndex={app.zIndex}\\n\\t\\t\\t\\t\\t/>\\n\\t\\t\\t\\t{/if}\\n\\t\\t\\t{/each}\\n\\t\\t\\t<div class=\\"icons\\">\\n\\t\\t\\t\\t{#each $iconState as icon (icon.id)}\\n\\t\\t\\t\\t\\t<div\\n\\t\\t\\t\\t\\t\\tclass=\\"icon icon-draggable\\"\\n\\t\\t\\t\\t\\t\\tclass:active={icon.active}\\n\\t\\t\\t\\t\\t\\ton:dblclick={() => handleIconClick(icon)}\\n\\t\\t\\t\\t\\t\\trole=\\"button\\"\\n\\t\\t\\t\\t\\t\\ttabindex=\\"0\\"\\n\\t\\t\\t\\t\\t\\ton:keydown={(event) => {\\n\\t\\t\\t\\t\\t\\t\\tif (event.key === 'Enter' || event.key === ' ') {\\n\\t\\t\\t\\t\\t\\t\\t\\tevent.preventDefault();\\n\\t\\t\\t\\t\\t\\t\\t\\thandleIconClick(icon);\\n\\t\\t\\t\\t\\t\\t\\t}\\n\\t\\t\\t\\t\\t\\t}}\\n\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t<img src={icon.icon} alt={icon.title} />\\n\\t\\t\\t\\t\\t\\t<p>{@html formatTitle(icon.title)}</p>\\n\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t{/each}\\n\\t\\t\\t</div>\\n\\n\\t\\t\\t<div class=\\"start-bar-container\\">\\n\\t\\t\\t\\t<StartBar />\\n\\t\\t\\t</div>\\n\\t\\t</div>\\n\\n\\n<style>\\n\\t#desktop {\\n\\t\\twidth: 100%;\\n\\t\\theight: calc(100% - 36px);\\n\\t\\toverflow-y: hidden;\\n\\t\\tbackground-color: none;\\n\\t}\\n\\n\\t.icon-draggable {\\n\\t\\tcursor: none;\\n\\t\\ttouch-action: none;\\n\\t\\tuser-select: none;\\n\\t}\\n\\n\\t.icon {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\twidth: 100px;\\n\\t\\talign-items: center;\\n\\t\\tjustify-content: center;\\n\\t\\tmargin: 1% 0 3% 1%;\\n\\t\\tpadding: 5px;\\n\\t\\tborder: 2px solid transparent;\\n\\t\\tborder-radius: 4px;\\n\\t\\tbox-sizing: border-box;\\n\\t\\tcursor: pointer;\\n\\t}\\n\\n\\t.icon img {\\n\\t\\twidth: 54px;\\n\\t\\theight: auto;\\n\\t}\\n\\n\\t.icon p {\\n\\t\\tposition: absolute;\\n\\t\\tline-height: 1.5;\\n\\t\\ttext-align: center;\\n\\t\\ttext-shadow: 1px 1px 2px black;\\n\\t\\tmargin-top: 96px;\\n\\t\\tfont-size: 12px;\\n\\t\\tword-wrap: break-word;\\n\\t\\toverflow: hidden;\\n\\t\\ttext-overflow: ellipsis;\\n\\t\\twhite-space: pre-line;\\n\\t\\tmax-width: 100%;\\n\\t}\\n\\n\\t.icon.active p {\\n\\t\\tbackground-color: #0078d7;\\n\\t\\tpadding: 1px 4px 1px 4px;\\n\\t\\tcolor: #ffffff;\\n\\t}\\n\\n\\t.icon.active img {\\n\\t\\topacity: 0.75;\\n\\t}\\n\\n\\t.icon:focus {\\n\\t\\toutline: none;\\n\\t}\\n\\n\\t.start-bar-container {\\n\\t\\tposition: fixed;\\n\\t\\tbottom: 0;\\n\\t\\tleft: 0;\\n\\t\\tright: 0;\\n\\t\\tz-index: 1000;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA4HC,oCAAS,CACR,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,CACzB,UAAU,CAAE,MAAM,CAClB,gBAAgB,CAAE,IACnB,CAEA,2CAAgB,CACf,MAAM,CAAE,IAAI,CACZ,YAAY,CAAE,IAAI,CAClB,WAAW,CAAE,IACd,CAEA,iCAAM,CACL,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,KAAK,CAAE,KAAK,CACZ,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,MAAM,CAAE,EAAE,CAAC,CAAC,CAAC,EAAE,CAAC,EAAE,CAClB,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,WAAW,CAC7B,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,UAAU,CACtB,MAAM,CAAE,OACT,CAEA,mBAAK,CAAC,iBAAI,CACT,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IACT,CAEA,mBAAK,CAAC,eAAE,CACP,QAAQ,CAAE,QAAQ,CAClB,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,MAAM,CAClB,WAAW,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAC9B,UAAU,CAAE,IAAI,CAChB,SAAS,CAAE,IAAI,CACf,SAAS,CAAE,UAAU,CACrB,QAAQ,CAAE,MAAM,CAChB,aAAa,CAAE,QAAQ,CACvB,WAAW,CAAE,QAAQ,CACrB,SAAS,CAAE,IACZ,CAEA,KAAK,qBAAO,CAAC,eAAE,CACd,gBAAgB,CAAE,OAAO,CACzB,OAAO,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CACxB,KAAK,CAAE,OACR,CAEA,KAAK,qBAAO,CAAC,iBAAI,CAChB,OAAO,CAAE,IACV,CAEA,iCAAK,MAAO,CACX,OAAO,CAAE,IACV,CAEA,gDAAqB,CACpB,QAAQ,CAAE,KAAK,CACf,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,CAAC,CACR,OAAO,CAAE,IACV"}`
};
function formatTitle(title) {
  const words = title.split(" ");
  if (words.length > 2) {
...
const Desktop = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $appState, $$unsubscribe_appState;
  let $iconState, $$unsubscribe_iconState;
  $$unsubscribe_appState = subscribe(appState, (value) => $appState = value);
  $$unsubscribe_iconState = subscribe(iconState, (value) => $iconState = value);
  function closeWindow(id) {
    removeApp(id);
  }
  function minimizeWindow(id) {
  ...
  $$unsubscribe_appState();
  $$unsubscribe_iconState();
  return `<div id="desktop" class="svelte-5obva5">${each($appState.apps, (app) => {
    return `${!app.minimized ? `${validate_component(Window, "Window").$$render(
      $$result,
      {
        window: app,
        onClose: () => closeWindow(app.id),
  ...
  })} <div class="icons">${each($iconState, (icon) => {
    return `<div class="${["icon icon-draggable svelte-5obva5", icon.active ? "active" : ""].join(" ").trim()}" role="button" tabindex="0"><img${add_attribute("src", icon.icon, 0)}${add_attribute("alt", icon.title, 0)} class="svelte-5obva5"> <p class="svelte-5obva5"><!-- HTML_TAG_START -->${formatTitle(icon.title)}<!-- HTML_TAG_END --></p> </div>`;
  })}</div> <div class="start-bar-container svelte-5obva5">${validate_component(StartBar, "StartBar").$$render($$result, {}, {}, {})}</div> </div>`;
});
const css = {
  code: ".mainContainer.svelte-1oo8gsg{margin:0;top:0;display:flex;width:100vw;height:100vh;background-image:url('https://i.imgur.com/Zk6TR5k.jpeg');background-repeat:no-repeat;background-size:cover;background-position:center}",
  map: `{"version":3,"file":"+page.svelte","sources":["+page.svelte"],"sourcesContent":["<script>\\n\\timport Desktop from './Desktop.svelte';\\n\\timport MediaQuery from '$lib/components/MediaQuery.svelte';\\n<\/script>\\n\\n<MediaQuery query=\\"(min-width: 1280px)\\" let:matches>\\n{#if matches}\\n<div class=\\"mainContainer\\">\\n\\t<Desktop />\\n</div>\\n{/if}\\n</MediaQuery>\\n\\n<style>\\n\\t.mainContainer {\\n\\t\\tmargin: 0;\\n\\t\\ttop: 0;\\n\\t\\tdisplay: flex;\\n\\t\\twidth: 100vw;\\n\\t\\theight: 100vh;\\n\\t\\tbackground-image: url('https://i.imgur.com/Zk6TR5k.jpeg');\\n\\t\\tbackground-repeat: no-repeat;\\n\\t\\tbackground-size: cover;\\n\\t\\tbackground-position: center;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAcC,6BAAe,CACd,MAAM,CAAE,CAAC,CACT,GAAG,CAAE,CAAC,CACN,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,CACb,gBAAgB,CAAE,uCAAuC,CACzD,iBAAiB,CAAE,SAAS,CAC5B,eAAe,CAAE,KAAK,CACtB,mBAAmB,CAAE,MACtB"}`
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${validate_component(MediaQuery, "MediaQuery").$$render($$result, { query: "(min-width: 1280px)" }, {}, {
    default: ({ matches }) => {
      return `${matches ? `<div class="mainContainer svelte-1oo8gsg">${validate_component(Desktop, "Desktop").$$render($$result, {}, {}, {})}</div>` : ``}`;
    }
  })}`;
});
export {
